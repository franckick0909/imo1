...
export default function FloatingCardsSection() {
  ...
  // Optimisation: useSpring pour des animations ultra-fluides
  ...
  // Animation de la fenêtre elliptique - avec spring pour fluidité
  const ellipseYRaw = useTransform(scrollYProgress, [0, 1], [-200, 200]);
  const ellipseY = useSpring(ellipseYRaw, springConfig);

  // Animation de l'image dans le mask - mouvement inverse optimisé
  const imageYRaw = useTransform(scrollYProgress, [0, 1], [150, -75]);
  const imageY = useSpring(imageYRaw, springConfig);

  // Animation des cartes avec spring
  const cardsTopYRaw = useTransform(scrollYProgress, [0, 1], [100, -100]);
  const cardsTopY = useSpring(cardsTopYRaw, springConfig);

  const cardsBottomYRaw = useTransform(scrollYProgress, [0, 1], [200, -200]);
  const cardsBottomY = useSpring(cardsBottomYRaw, springConfig);

  const veraYRaw = useTransform(scrollYProgress, [0, 1], [300, -500]);
  const veraY = useSpring(veraYRaw, springConfig);
      ...
      >
        ...
        <div className="hidden lg:block">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute inset-0 ellipse-responsive clip-optimized "
            >
              <motion.div
                style={{
                  y: imageY,
          ...
          >
            <div className="relative w-full h-full px-8 lg:px-16 py-16">
              ...
              >
                <motion.div
                  className="min-h-[350px] bg-zinc-100/50 backdrop-blur-xs p-8 rounded-2xl shadow-md border border-white flex flex-col justify-center card-optimized"
        ...
        <div className="block lg:hidden relative z-30 h-full">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-shrink-0 relative h-[50vh] flex items-center justify-center">
              <motion.div
                style={{
                  y: ellipseY,
                  willChange: "transform",
              ...
              >
                <motion.div
                  ...
                  className="absolute inset-0 clip-optimized"
                >
                  <motion.div
                    style={{
                      y: imageY,
                    ...
                    className="absolute inset-0 parallax-optimized"
                  >
                    <Image
                      src="/images/clippath.jpg"
                      alt="Femme appliquant des soins naturels"
            ...
            <div className="flex-grow pt-20 pb-16 px-1 sm:px-4 md:px-8">
              <div className="grid grid-cols-2 sm:grid-cols-2 gap-1 max-w-6xl mx-auto">
                {features.map((feature, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                  >
                    <div className="w-full max-w-sm mx-auto min-h-[320px] md:min-h-[280px] bg-zinc-100/50 sm:backdrop-blur-xs p-2 sm:p-4 md:p-6 sm:rounded-2xl sm:border border-zinc-200 flex flex-col justify-center card-optimized">
