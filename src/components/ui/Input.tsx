...
const Input = forwardRef<HTMLInputElement, InputProps>(
  ({ label, error, success, type, className, ...props }, ref) => {
    ...
    const getInputStyles = () => {
      const baseStyles =
        "w-full px-2 py-2 bg-transparent border-0 border-b-1 transition-all duration-200 focus:outline-none text-gray-900 placeholder-gray-500 placeholder:text-xs sm:placeholder:text-sm";
