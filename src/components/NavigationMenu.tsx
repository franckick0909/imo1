  ...
  return (
    <>
      ...
      <AnimatePresence mode="wait">
        {isMenuOpen && (
          <motion.div
            className="fixed top-2 sm:top-3 md:top-4 left-3 sm:left-4 md:left-6 bg-white z-40 flex flex-col rounded-2xl sm:rounded-3xl min-w-20 sm:min-w-24 min-h-8 sm:min-h-10 overflow-hidden border border-emerald-300"
